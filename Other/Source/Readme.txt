...
user in an INI file next to ATTOBenchPortable.exe called ATTOBenchPortable.ini.
...
copy AppNamePortable.ini from this directory to ATTOBenchPortable.ini next to
ATTOBenchPortable.exe. The options in the INI file are as follows:
